...
Modules:
    ...
    classifier   -- Cell classification (k-means, GMM, DBSCAN, rules, multi-Otsu)
    ...
    statistics     -- Hypothesis testing, post-hoc comparisons, p-value correction
    ...
    parasitology   -- Blood smear parasitology: RBC counting, stage classification
"""
...
from .tracking import (
    ...
    smooth_trajectory, kalman_smooth, trajectory_speed, trajectory_curvature,
...
from .classifier import (
    extract_features, classify_kmeans, classify_gmm, classify_dbscan,
    classify_rules, classify_composite,
    classify_size_bins, multi_otsu, feature_importance,
)
from .spatial import (
...
from .statistics import (
    compare_two, compare_multiple, pairwise_comparisons, correct_pvalues,
    confidence_interval, effect_size, bootstrap_ci, estimate_required_n,
)
from .contour import (
...
from .histology import (
    deconvolve_hae, deconvolve_giemsa, segment_nuclei_hae, detect_necrosis,
    assess_glands, measure_pleomorphism, detect_mitoses, grade_tumor,
)
from .treatment import (
    compute_change, classify_response, compare_conditions,
    temporal_response, compute_half_time, recovery_fraction,
)
...
from .cell_cycle import (
    ...
    proliferation_markers, cycle_phase_summary, classify_fucci_phases,
)
...
from .parasitology import (
    count_rbcs, detect_infected, classify_stage, classify_stages,
    compute_parasitemia, analyze_blood_smear,
)
from .chromatin import (
    measure_chromatin_texture, heterochromatin_fraction, detect_nucleoli,
    detect_micronuclei, nuclear_shape_metrics, chromatin_condensation_score,
    chromatin_profile, population_chromatin,
)
from .color_analysis import (
    nucleus_color, detect_color_region, color_profile,
    classify_wbc, hsv_mask,
)
from .condensate import (
    detect_foci, detect_foci_threshold, foci_per_cell, spatial_distribution,
    foci_intensity_profile, stress_response_index, aggregation_score,
    foci_statistics,
)
from .cytoskeleton import (
    enhance_fibers, segment_fibers, classify_fiber_subtype,
    analyze_cell_fibers, fiber_differential,
)
from .lipid_droplet import (
    detect_lipid_droplets, droplet_morphology, droplet_count_per_cell,
    lipid_content_score, steatosis_index, adipogenesis_score,
    lipid_droplet_analysis, population_lipid,
)
from .parameter_advisor import (
    suggest_watershed_params, suggest_tracking_params,
    suggest_detection_params, suggest_log_params, suggest_nc_params,
    suggest_sampling_params, parameter_report,
)
from .run_tumble import (
    build_tracks, step_speeds, speed_valley, classify_run_tumble,
    extract_run_segments, analyze_run_tumble, validate_tracks,
)
from .sphere_3d import (
    dof_visible_fraction, extrapolate_sphere_surface,
    dof_for_objective, dof_in_pixels, sphere_surface_area,
    estimate_cell_density, equatorial_ring_area, interior_visible_fraction,
)
from .spt import (
    detect_spots, link_tracks_gap,
    classify_track, analyze_spt, sigma_step,
)
from .puncta import (
    detect_puncta_log, detect_elongated_puncta, detect_puncta_multiscale,
    segment_cells_from_nuclei, count_puncta_per_cell,
    puncta_statistics, lysosome_analysis,
)
