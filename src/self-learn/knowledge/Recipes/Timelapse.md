...
### Quick Timelapse (preferred for single-channel)
```python
from src.core.hardware.core import timelapse
stack = timelapse(core, n_frames=20, interval_s=2.0, channel="brightfield")
# Returns 3D numpy array (T, H, W) ready for analysis
```

### Basic MDASequence (multi-channel or complex)
```python
...
- **Drift between frames**: Use drift_corrected_timelapse for Z-drift, or
  phase_correlate/fft_cross_correlate from src.core.hardware.drift for XY drift.
