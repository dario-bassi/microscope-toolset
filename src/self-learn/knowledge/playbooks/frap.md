...
```python
from src.hardware.core import snap, make_slm_circle, run_events
from src.hardware.config import get_config

# Scout channels — find the fluorescent channel to bleach
from src.workflows.scouting import channel_scout
...
```python
from src.analysis.kinetics import fit_exponential_recovery
