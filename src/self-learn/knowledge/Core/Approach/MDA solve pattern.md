...
```python
from src.core.workflows.experiment import phase_timelapse, baseline_treatment
from src.core.hardware.core import run_events
...
```python
from src.core.workflows.batch import tile_and_analyze
...
- Primary execution: `run_events(core, events, on_frame=callback)` from `src.core.hardware.core`
